  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyCKsv_PRcmQdZX9s5vdeDkWEJREu1hqZtk',
        appId: '1:605292502635:web:e7bfeef51bef874c09db2e',
        messagingSenderId: '605292502635',
        projectId: 'scoutes-app',
        storageBucket: "scoutes-app.appspot.com",
      ),
    );
  } else {
    await Firebase.initializeApp();
